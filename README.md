...
plugin that triggers the same CLI. Install it project-locally:
...
it after the idle timeout. See `docs/opencode-compatibility.md` for the full
mapping and the npm-install path.
